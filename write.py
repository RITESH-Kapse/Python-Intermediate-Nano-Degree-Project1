...
def write_to_csv(results, filename):
    ...
    """
    # Storing date in csv with headers using DictWriter.
...
def write_to_json(results, filename):
    ...
    """
    # Writting the values to json by creating empty list
    # and appending dict values as suggested
    # and storing in file with indent = 2
